...
var MsalContext = /*#__PURE__*/react.createContext(defaultMsalContext);
...
function MsalProvider(_ref) {
  ...
  var _useState = react.useState([]),
      ...
      setAccounts = _useState[1]; // State hook to store in progress value


  var _useState2 = react.useState(InteractionStatus.Startup),
...
var useMsal = function useMsal() {
  return react.useContext(MsalContext);
};
...
function useAccount(accountIdentifiers) {
  ...
  var _useState = react.useState(initialStateValue),
      account = _useState[0],
...
function useIsAuthenticated(matchAccount) {
  ...
  var _useState = react.useState(initialStateValue),
      ...
      setHasAuthenticated = _useState[1];
...
function AuthenticatedTemplate(_ref) {
  var username = _ref.username,
      ...
      children = _ref.children;
  var context = useMsal();
  var accountIdentifier = react.useMemo(function () {
    return {
      username: username,
